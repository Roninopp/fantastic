...
async def hmm(yes):
    ...
    Miku = f"♡ **Hey [{yes.sender.first_name}](tg://user?id={yes.sender.id}), I'm Fantastic manager**\n\n"
    ...
    BUTTON = [[Button.url("Support Chat", "https://t.me/MikusSupport"), Button.url("Updates Channel", "https://t.me/liu_WULANG_MONKES")]]
